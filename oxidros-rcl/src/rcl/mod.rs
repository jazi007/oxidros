...
use crate::{
    error::{Result, action_ret_val_to_err, ret_val_to_err},
    parameter::Value,
};
...
impl MTUnsafeFn {
    ...
    pub fn rcl_context_fini(&self, context: *mut rcl_context_t) -> Result<()> {
    ...
    pub fn rcl_init_options_fini(&self, init_options: *mut rcl_init_options_t) -> Result<()> {
    ...
    pub fn rcl_node_fini(&self, node: *mut rcl_node_t) -> Result<()> {
        ret_val_to_err(unsafe { self::rcl_node_fini(node) })
    }

    pub fn rcl_node_options_fini(&self, options: *mut rcl_node_options_t) -> Result<()> {
    ...
    pub fn rcl_wait_set_clear(&self, wait_set: *mut rcl_wait_set_t) -> Result<()> {
    ...
    pub fn rcl_wait_set_fini(&self, wait_set: *mut rcl_wait_set_t) -> Result<()> {
    ...
    pub fn rcl_client_fini(&self, client: *mut rcl_client_t, node: *mut rcl_node_t) -> Result<()> {
    ...
    pub fn rcl_ros_clock_fini(&self, clock: *mut rcl_clock_t) -> Result<()> {
    ...
    pub fn rcl_logging_fini(&self) -> Result<()> {
    ...
    #[cfg(any(ros_distro_jazzy, ros_distro_lyrical))]
...
impl MTUnsafeLogFn {
    ...
    pub fn rcutils_logging_initialize(&self) -> Result<()> {
...
impl MTSafeFn {
    ...
    pub fn rcl_shutdown(context: *mut rcl_context_t) -> Result<()> {
    ...
    pub fn rcl_wait(wait_set: *mut rcl_wait_set_t, timeout: i64) -> Result<()> {
