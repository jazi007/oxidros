...
|------------|----------------------------|
| int32[5]   | [i32; 5]                   |
| int32[]    | oxidros::msg::I32Seq<0> |
| int32[<=5] | oxidros::msg::I32Seq<5> |
...
pub struct MyMsg {
    ...
    pub unbounded_integer_array: oxidros::msg::I32Seq<0>,
    pub five_integers_array: [i32; 5],
    pub up_to_five_integers_array: oxidros::msg::I32Seq<5>,
}
```
...
```rust
use my_interfaces;
use oxidros::{context::Context, error::DynError, logger::Logger, pr_info};
...
So, there are arrays for unbounded and bounded strings as follows; `msg` is `oxidros::msg`.
...
#[derive(Debug)]
pub struct MyMsgStr {
    pub message: oxidros::msg::RosString<0>,
    pub static_array_str: [oxidros::msg::RosString<0>; 2],
    pub dynamic_array_str: oxidros::msg::RosStringSeq<0, 0>,
    pub bounded_array_str: oxidros::msg::RosStringSeq<0, 3>,
    pub bounded_str: oxidros::msg::RosString<10>,
    pub static_array_bounded_str: [oxidros::msg::RosString<10>; 2],
    pub dynamic_array_bounded_str: oxidros::msg::RosStringSeq<10, 0>,
    pub bounded_array_bounded_str: oxidros::msg::RosStringSeq<10, 3>,
}
```
