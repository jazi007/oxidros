...
The type of parameter value is defined by `oxidros::parameter::Value` as follows.
...
A parameter is associated with a descriptor of `oxidros::parameter::Descriptor` as follows.
...
So, a parameter and parameters can be represented by `oxidros::parameter::{Parameter, Parameters}` as follows.
...
`oxidros::parameter::ParameterServer` as follows.
