...
// Include generated message modules from src/generated/
// These files are either pre-committed or regenerated by build.rs when ROS2 is available
pub mod common_interfaces {
    //! Common ROS2 interface messages (geometry_msgs, sensor_msgs, etc.)
    include!("generated/common_interfaces/mod.rs");
}

pub mod interfaces {
    //! ROS2 core interfaces (rcl_interfaces, action_msgs, etc.)
    include!("generated/interfaces/mod.rs");
}

pub mod ros2msg {
    //! Additional ROS2 messages (unique_identifier_msgs, etc.)
    include!("generated/ros2msg/mod.rs");
}
