...
// Include generated message modules from OUT_DIR/generated/
// build.rs always populates OUT_DIR (either by generating fresh or copying pre-committed files)
#[rustfmt::skip]
pub mod common_interfaces {
    //! Common ROS2 interface messages (geometry_msgs, sensor_msgs, etc.)
    include!(concat!(env!("OUT_DIR"), "/generated/common_interfaces/mod.rs"));
}

#[rustfmt::skip]
pub mod interfaces {
    //! ROS2 core interfaces (rcl_interfaces, action_msgs, etc.)
    include!(concat!(env!("OUT_DIR"), "/generated/interfaces/mod.rs"));
}

#[rustfmt::skip]
pub mod ros2msg {
    //! Additional ROS2 messages (unique_identifier_msgs, etc.)
    include!(concat!(env!("OUT_DIR"), "/generated/ros2msg/mod.rs"));
}
