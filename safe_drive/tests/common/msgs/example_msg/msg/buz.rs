...
use super::*;
use safe_drive_v2::msg::common_interfaces::*;
use safe_drive_v2::msg::*;
use safe_drive_v2::rcl;
...
extern "C" {
    ...
    fn example_msg__msg__Buz__Sequence__are_equal(
        lhs: *const BuzSeqRaw,
        rhs: *const BuzSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__example_msg__msg__Buz(
...
#[derive(Debug)]
pub struct Buz {
    pub c: safe_drive_v2::msg::RosString<0>,
}
...
impl PartialEq for Buz {
    fn eq(&self, other: &Self) -> bool {
        unsafe { example_msg__msg__Buz__are_equal(self, other) }
    }
}
